    ...
    return steps.map((step, index) => {
      ...
      return (
        <Col md={6} lg={4} key={index}>
          <Card className={`mb-4 ${currentStep === index ? "border-primary" : ""}`}>
            <Card.Body>
            ...
            {step.map((value, idx) => (
              <div
                ...
                style={{
                  ...
                  padding: "10px",
                  margin: "0 5px",
                  border: swapIndices.includes(idx) ? "2px solid #ff6f61" : "1px solid #000",
                  backgroundColor: swapIndices.includes(idx) ? "#ff6f61" : "#fff",
